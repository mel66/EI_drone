...
class Node(rclpy.node.Node):
    ...
    def __init__(self):
        ...
        self.sub_behaviors_status = self.create_subscription(BehaviorStatus, 'behaviors_status', self._on_behaviors_status, 10)
        ...
        self.create_timer(10.0, callback = self._on_last_seen)
