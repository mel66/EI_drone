...
#include "behavior_interface/msg/detail/behavior_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = behavior_interface::msg::BehaviorStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const behavior_interface::msg::BehaviorStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<behavior_interface::msg::BehaviorStatus *>(
    untyped_ros_message);
...
{
  return &behavior_interface::msg::typesupport_fastrtps_cpp::_BehaviorStatus__handle;
}
