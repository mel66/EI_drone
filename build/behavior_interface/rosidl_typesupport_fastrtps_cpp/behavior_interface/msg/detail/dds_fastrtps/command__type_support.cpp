...
#include "behavior_interface/msg/detail/command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const behavior_interface::msg::Command & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  behavior_interface::msg::Command & ros_message)
{
  // Member: command
  cdr >> ros_message.command;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = behavior_interface::msg::Command;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const behavior_interface::msg::Command *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<behavior_interface::msg::Command *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_behavior_interface
const rosidl_message_type_support_t *
get_message_type_support_handle<behavior_interface::msg::Command>()
{
  return &behavior_interface::msg::typesupport_fastrtps_cpp::_Command__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, behavior_interface, msg, Command)() {
  return &behavior_interface::msg::typesupport_fastrtps_cpp::_Command__handle;
}
