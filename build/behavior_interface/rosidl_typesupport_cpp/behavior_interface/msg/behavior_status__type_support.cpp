...
static const _BehaviorStatus_type_support_symbol_names_t _BehaviorStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, behavior_interface, msg, BehaviorStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, behavior_interface, msg, BehaviorStatus)),
  }
};
...
{
  return &::behavior_interface::msg::rosidl_typesupport_cpp::BehaviorStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, behavior_interface, msg, BehaviorStatus)() {
  return get_message_type_support_handle<behavior_interface::msg::BehaviorStatus>();
}
