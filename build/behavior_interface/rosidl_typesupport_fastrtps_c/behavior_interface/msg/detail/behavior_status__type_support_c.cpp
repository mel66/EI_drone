...
#include "behavior_interface/msg/detail/behavior_status__rosidl_typesupport_fastrtps_c.h"
...
#include "behavior_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _BehaviorStatus__ros_msg_type = behavior_interface__msg__BehaviorStatus;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_behavior_interface
size_t get_serialized_size_behavior_interface__msg__BehaviorStatus(
  const void * untyped_ros_message,
...
static uint32_t _BehaviorStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_behavior_interface__msg__BehaviorStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_behavior_interface
size_t max_serialized_size_behavior_interface__msg__BehaviorStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = behavior_interface__msg__BehaviorStatus;
    is_plain =
      (
...
static size_t _BehaviorStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_behavior_interface__msg__BehaviorStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, behavior_interface, msg, BehaviorStatus)() {
